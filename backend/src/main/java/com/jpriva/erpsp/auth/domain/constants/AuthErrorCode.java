...
public enum AuthErrorCode implements ErrorCode {
    ...
    USER_ALREADY_VERIFIED("USER_ALREADY_VERIFIED", "User is already verified.", 409),
    USER_BLOCKED("USER_BLOCKED", "User is blocked.", 403),
    USER_NOT_VERIFIABLE("USER_NOT_VERIFIABLE", "User is not verifiable.", 403),
